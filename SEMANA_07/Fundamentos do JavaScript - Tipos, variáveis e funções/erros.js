/* 
    Ao declarar uma constante sem atribuir um valor a ela, aparecerá um erro de sintax, pois uma constante precisa ser declarada!
    ex: const numero; //Com Erro
*/
const numero = "oi"; // sem Erro

/* 
    Ao chamar uma variavel ainda não declarada teremos um erro de referencia
*/
...
/* 
    OUTROS TIPOS DE ERROS NO JAVASCRIPT
